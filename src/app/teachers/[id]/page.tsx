  ...
  return (
    <div>
      <PageHeader 
        ...
        bgImage={`https://picsum.photos/1920/600?random=teacher${teacher.id}`}
      />
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="flex flex-col md:flex-row gap-8">
              ...
              <div className="w-full md:w-2/3">
                <h1 className="text-3xl font-bold font-serif-sc text-gray-900 mb-2">
                  {teacher.name}
                </h1>
                
                <div className="flex items-center gap-4 text-sm text-gray-500 mb-6">
                  <span className="px-3 py-1 bg-red-100 text-zk-red rounded-full font-medium">
                    {teacher.title}
                  </span>
                  <span className="text-zk-blue font-medium">
                    {teacher.subject}
                  </span>
                </div>
