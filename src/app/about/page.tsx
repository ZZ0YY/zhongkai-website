          ...
          <div className="flex flex-col md:flex-row gap-12 items-start">
            ...
            <div className="w-full md:w-1/2">
              ...
              <div className="grid grid-cols-2 gap-4 mt-4">
                <img src="https://picsum.photos/400/300?random=52" alt="Classroom" className="rounded-lg shadow-md" loading="lazy" />
                <img src="https://picsum.photos/400/300?random=53" alt="Library" className="rounded-lg shadow-md" loading="lazy" />
              </div>
            </div>
            ...
            <div className="w-full md:w-1/2">
              ...
              <div className="prose text-gray-600 mb-8">
                ...
                <p className="mb-4">
                  自2006年被评为"广东省一级学校"以来，学校不断追求卓越，于2008年再获"广东省普通高中教学水平优秀学校"殊荣。多年来，学校始终坚持党的教育方针，以立德树人为根本任务，形成了"尚德、博学、健体、力行"的优良校风。
                </p>
              </div>
